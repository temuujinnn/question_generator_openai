...
Lesson topic: *Lesson Topic*`;
    ...
    try {
      ...
      const correctAnswerLetter = ['A', 'B', 'C', 'D'][Math.floor(Math.random() * 4)];


      const createdSampleData = {

        context: question,


        answers: [
          { id: 'a0', isCorrect: correctAnswerLetter === 'A', value: options.A },
          { id: 'a1', isCorrect: correctAnswerLetter === 'B', value: options.B },
          { id: 'a2', isCorrect: correctAnswerLetter === 'C', value: options.C },
          { id: 'a3', isCorrect: correctAnswerLetter === 'D', value: options.D },
        ],
        topic: currentTopic,


        lessonId: '64266f8ea61fa996674cd82c',

      };
      return createdSampleData;
    }
